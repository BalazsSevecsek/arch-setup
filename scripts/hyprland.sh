...
sudo pacman -S --needed --noconfirm uwsm hyprland  waybar hyprpaper hyprsunset hyprlock hypridle playerctl hypershot walker mako fcitx5 swaybg swayosd-server
